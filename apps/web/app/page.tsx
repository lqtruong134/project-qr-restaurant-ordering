...
export default async function Home() {
  ...
  return <main>
    ...
    <section className="intro"><span className="eyebrow">SPRINT 01 / NỀN TẢNG</span><h1>Khởi đầu từ một<br/><em>nền tảng vững chắc.</em></h1><p>Môi trường phát triển cho website gọi món tại bàn.<br/>Theo dõi kết nối và chuẩn bị bước thiết kế dữ liệu.</p></section>
    ...
    <section className="milestones" aria-label="Lộ trình Sprint 1">{[
      ['01', 'Bộ khung dự án', 'Môi trường và kiểm tra chất lượng', 'Đang kiểm chứng'],
      ['02', 'Thiết kế dữ liệu', 'ERD và migration 14 bảng C0–C1', 'Tiếp theo'],
      ['03', 'Đăng nhập & quyền', 'Staff · Kitchen · Admin', 'Chưa triển khai'],
      ['04', 'Dữ liệu & demo', 'Seed, từ điển dữ liệu và diễn tập', 'Chưa triển khai'],
    ...
    <footer><span>Mốc Sprint Review</span><strong>20 tháng 09, 2026</strong><span>EN-C0-01 · Môi trường local</span></footer>
  </main>;
}
